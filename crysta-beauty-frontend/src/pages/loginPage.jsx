...
export default function LoginPage(){
    ...
    return(
        <div className="w-full h-screen bg-[url(/loginpage.jpg)] bg-cover bg-center flex">
           ...
           <div className="w-[450px] h-[600px] backdrop-blur-xl shadow-xl rounded-xl">
                 ...
                 className="w-[400px] h-[50px] border border-white rounded-xl text-center m-[5px]" type="email" placeholder="email"/>
                  ...
                  )}className="w-[400px] h-[50px] border border-white rounded-xl text-center m-[5px]" type="passowrd" placeholder="password"/>
